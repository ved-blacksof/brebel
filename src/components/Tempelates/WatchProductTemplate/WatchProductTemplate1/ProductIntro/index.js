    ...
    return (
        ...
        <Box className={classes.carouselBox}>
            ...
            <div className={classes.watchBox}>
                <img className={classes.watchImg} src={'./images/Layer 01.png'} alt="intro product images" />
            </div>

            <img className={classes.watchImg2} src={'./images/Layer 01.png'} alt="intro product images" />
